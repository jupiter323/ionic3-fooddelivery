...
/**
 * Generated class for the DeletefavoritePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-deletefavorite',
  templateUrl: 'deletefavorite.html',
})
export class DeletefavoritePage {
  ...
  deleteOrders() {
      this.restaurantsList = this.restaurantsList.filter((xx, ii) => !xx.selected);
      this.navCtrl.pop();   
  }
